...
--[[	LoadActor("../ScreenWithMenuElements background/line") .. {
	...
	LoadActor(THEME:GetPathG("_credits/credits","light")) .. {
		InitCommand=cmd(y,-20;blend,'BlendMode_Add');
		OnCommand=cmd(diffusealpha,0;sleep,115;rotationy,0;y,-30;linear,4;rotationy,90;diffusealpha,1;y,-20;linear,4;rotationy,180;y,-10;diffusealpha,0;);
	};
	LoadActor(THEME:GetPathG("_credits/credits","light")) .. {
		InitCommand=cmd(y,-20;blend,'BlendMode_Add');
		OnCommand=cmd(diffusealpha,0;sleep,115;rotationy,90;y,-30;linear,4;rotationy,180;diffusealpha,1;y,-20;linear,4;rotationy,270;y,-10;diffusealpha,0;);
	};
	LoadActor(THEME:GetPathG("_credits/credits","light")) .. {
		InitCommand=cmd(y,-20;blend,'BlendMode_Add');
		OnCommand=cmd(diffusealpha,0;sleep,115;rotationy,90-45;y,-30;linear,4;rotationy,180-45;diffusealpha,1;y,-20;linear,4;rotationy,270-45;y,-10;diffusealpha,0;);
	};
	LoadActor(THEME:GetPathG("_credits/credits","light")) .. {
		InitCommand=cmd(y,-20;blend,'BlendMode_Add');
		OnCommand=cmd(diffusealpha,0;sleep,115;rotationy,90+45;y,-30;linear,4;rotationy,180+45;diffusealpha,1;y,-20;linear,4;rotationy,270+45;y,-10;diffusealpha,0;);
