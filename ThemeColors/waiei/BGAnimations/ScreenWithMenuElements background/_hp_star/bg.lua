...
local t=Def.ActorFrame {
  ...
  InitCommand=cmd(Center);
	Def.Quad {
		InitCommand=cmd(scaletoclipped,SCREEN_WIDTH,SCREEN_HEIGHT*2/3;y,-SCREEN_HEIGHT/6);
		--OnCommand=cmd(diffuse,color("#ffffff");diffusetopedge,color("#80c0ff"));
		OnCommand=cmd(diffuse,color("#80c0ff");diffusetopedge,color("#80c0ff"));
	};
	Def.Quad {
		InitCommand=cmd(scaletoclipped,SCREEN_WIDTH,SCREEN_HEIGHT/2;y,SCREEN_CENTER_Y-(SCREEN_HEIGHT/6));
		--OnCommand=cmd(diffuse,color("#ffff99");diffusebottomedge,color("#c0cc33"));
		OnCommand=cmd(diffuse,color("#80c0ff");diffusebottomedge,color("#ffffff"));
	};
	LoadActor("../line") .. {
