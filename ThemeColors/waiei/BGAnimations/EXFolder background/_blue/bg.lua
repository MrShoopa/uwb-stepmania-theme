...
local t=Def.ActorFrame {
  ...
  InitCommand=cmd(Center);
	...
	LoadActor("../../ScreenWithMenuElements background/_blue/line") .. {
		InitCommand=cmd(zoomto,SCREEN_WIDTH*2.2,SCREEN_HEIGHT*2;diffuse,ColorLightTone(color("#000080"));rotationy,-20;customtexturerect,0,0,SCREEN_WIDTH*1.5/48,SCREEN_HEIGHT*1.5/96);
	...
	LoadActor("../../ScreenWithMenuElements background/_blue/panel") .. {
	...
	LoadActor("../../ScreenWithMenuElements background/_blue/fan_1") .. {
	...
	LoadActor("../../ScreenWithMenuElements background/_blue/_particleLoader") .. {
