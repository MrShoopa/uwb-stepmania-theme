...
local t=Def.ActorFrame {
  ...
  InitCommand=cmd(Center);
	LoadActor("../../ScreenWithMenuElements background/_fixed5/_bg_01") .. {
		InitCommand=cmd(zoomto,SCREEN_WIDTH*2,SCREEN_HEIGHT*2;);
	};
	LoadActor("../../ScreenWithMenuElements background/_fixed5/white") .. {
		InitCommand=cmd(blend,"BlendMode_Add");
	};
	LoadActor("../../ScreenWithMenuElements background/_fixed5/_bg_02") .. {
	...
	LoadActor("../../ScreenWithMenuElements background/_fixed5/_over_01") .. {
		InitCommand=cmd(blend,"BlendMode_Add";diffusealpha,0.5;);
		OnCommand=cmd(texcoordvelocity,0.02,0;);
	};
	LoadActor("../../ScreenWithMenuElements background/_fixed5/_over_02") .. {
		InitCommand=cmd(blend,"BlendMode_Add";diffusealpha,0.5;);
		OnCommand=cmd(texcoordvelocity,-0.02,0;);
	};
	LoadActor("../../ScreenWithMenuElements background/_fixed5/komono") .. {
