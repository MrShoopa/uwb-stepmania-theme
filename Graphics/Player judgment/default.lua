...
local mode=(TC_GetwaieiMode()==2) and "waiei2" or "waiei1";

local JudgeCmds = {
	TapNoteScore_W1 = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentW1Command" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentW1Command" ));
	TapNoteScore_W2 = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentW2Command" ));
	TapNoteScore_W3 = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentW3Command" ));
	TapNoteScore_W4 = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentW4Command" ));
	TapNoteScore_W5 = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentW5Command" ));
	TapNoteScore_Miss = ((haishin=="Off") and THEME:GetMetric( "Judgment_"..mode, "JudgmentMissCommand" ) or THEME:GetMetric( "HaishinJudgment_"..mode, "JudgmentMissCommand" ));
};
...
t[#t+1] = Def.ActorFrame {
	LoadActor(TC_GetPath("Judgment",judType)) .. {
		Name="Judgment";
		InitCommand=cmd(pause;visible,false);
		OnCommand=THEME:GetMetric("Judgment_"..mode,"JudgmentOnCommand");
