...
local t=Def.ActorFrame{
	...
	LoadActor("frame_light")..{
		InitCommand=cmd(horizalign,left;vertalign,top;
			x,0;y,0;zoomtowidth,SCREEN_CENTER_X/2;blend,"BlendMode_Add";diffusealpha,0);
		LightLeftCommand=function(self)
			self:diffusealpha(1-beat_player[1]);
		end;
	};
	LoadActor("frame_light")..{
		InitCommand=cmd(rotationy,180;horizalign,left;vertalign,top;
			x,SCREEN_RIGHT;y,0;zoomtowidth,SCREEN_CENTER_X/2;blend,"BlendMode_Add";diffusealpha,0);
		LightRightCommand=function(self)
			self:diffusealpha(1-beat_player[2]);
		end;
	};
	LoadActor("frame_light")..{
		InitCommand=cmd(horizalign,left;vertalign,top;rotationx,180;
			x,0;y,SCREEN_BOTTOM;zoomtowidth,SCREEN_CENTER_X/2;blend,"BlendMode_Add";diffusealpha,0);
		LightLeftCommand=function(self)
			self:diffusealpha(1-beat_player[1]);
		end;
	};
	LoadActor("frame_light")..{
		InitCommand=cmd(rotationy,180;horizalign,left;vertalign,top;rotationx,180;
			x,SCREEN_RIGHT;y,SCREEN_BOTTOM;zoomtowidth,SCREEN_CENTER_X/2;blend,"BlendMode_Add";diffusealpha,0);
		LightRightCommand=function(self)
			self:diffusealpha(1-beat_player[2]);
		end;
	};
